...
def train_classifier(dataset_num):
    ...
    train_data_path = f'{base_path}/TrainData{dataset_num}.txt'
    train_label_path = f'{base_path}/TrainLabel{dataset_num}.txt'
    test_data_path = f'{base_path}/TestData{dataset_num}.txt'
    ...
    output_path = f'{output_dir}/test_result{dataset_num}.txt'
